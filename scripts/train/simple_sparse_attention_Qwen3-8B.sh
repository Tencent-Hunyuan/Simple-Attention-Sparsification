...
OUTPUT_DIR=${OUTPUT_DIR:-./outputs/simple_sparse_attention/Qwen3-8B-openr1-math-b${blocksize}k${topk}}
...
pixi run bash scripts/train/train.sh -m sas.train.trainer \
    ...
    --train.wandb_name simple_sparse_attention-Qwen3-8B-openr1-math-b${blocksize}k${topk} \
